...
class AppColors {
  ...
  // ── Brand ──────────────────────────────────────────────────────────────────
  static const Color primary       = ColorTokens.light.primary;
  ...
  static const Color accent        = ColorTokens.light.accent;
  ...
  static const Color error   = ColorTokens.light.error;
  static const Color info    = Color(0xFF0277BD);

  // ── Neutral ────────────────────────────────────────────────────────────────
  static const Color background    = ColorTokens.light.background;
  static const Color surface       = ColorTokens.light.surface;
  ...
  // ── Text ───────────────────────────────────────────────────────────────────
  static const Color textPrimary   = ColorTokens.light.textPrimary;
  static const Color textSecondary = ColorTokens.light.textSecondary;
  static const Color textDisabled  = Color(0xFFA0B5B0);
  static const Color textOnPrimary = ColorTokens.light.onPrimary;
  static const Color textOnAccent  = ColorTokens.light.onAccent;
...
class AppTypography {
  ...
  static const TextStyle displayMedium = TextStyle(
    fontFamily: fontFamily, fontSize: 26, fontWeight: FontWeight.w700,
...
class AppMotion {
  ...
  static const Duration normal = Duration(milliseconds: 300); // MotionTokens.normal
  ...
  static const Curve decelerate = Curves.easeOutCubic; // MotionTokens.easeOutCubic
}
